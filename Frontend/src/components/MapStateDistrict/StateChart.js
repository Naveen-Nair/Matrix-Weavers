...
const StateChart = ({ setTooltipContent, setDistrictName, selectedState }) => {
    ...
    return (
      <>
        <ComposableMap projection="geoMercator" width={150} height={150} projectionConfig={{ scale: scaleMap }}>
              ...
              {({ geographies }) =>
                geographies.map(geo => (
                  <Geography
                    ...
                    data-tooltip-content={geo.properties.district} // Attach tooltip content directly here
                    onMouseEnter={() => {
